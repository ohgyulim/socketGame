...
pygame.init()
pygame.display.set_caption('1v1_game_server')
height=400
width=600
...
enemy_img = pygame.image.load('penguin_final1.png')
enemy_img2 = pygame.image.load('penguin_final2.png')
...
def GameMain():
    ...
    img = pygame.image.load('penguin_blue.png')
    img2 = pygame.image.load('penguin_blue2.png')
    imgh=img.get_size()[1]
    imgw=img.get_size()[0]
    x=50
